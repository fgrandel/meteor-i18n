...
(function() {
  ...
  Meteor._TranslatorService = (function() {
    _TranslatorService.prototype._DEFAULT_LOCALE = 'en_US';
    ...
    function _TranslatorService() {
      ...
      retrieveMessage = function(messageId) {
        ...
        locale = Session.get('_TranslatorService.locale') || _this._DEFAULT_LOCALE;
      ...
      this.translate = function(messageId, params) {
        var e, errorMessage, errorMessageId, message, translationError;
        if (params == null) {
          params = {};
        }
        try {
  ...
  Handlebars.registerHelper('__', function(string, content) {
    ...
    t = '';
    if (string) {
      t = Meteor._TranslatorService.translate(string, {
        message: content
      });
    }
    return t;
